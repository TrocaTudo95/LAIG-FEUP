...
bezier_distance(c_pts)
  {
	...
	let d1=this.distanceBetweenPoints(c_pts[0],p1);
	let d2=this.distanceBetweenPoints(p1,p4);
	let d3=this.distanceBetweenPoints(p4,p5);
	let d4=this.distanceBetweenPoints(p5,c_pts[3]);
